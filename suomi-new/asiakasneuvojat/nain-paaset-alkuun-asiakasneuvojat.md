...
![](<../.gitbook/assets/Kutsu kanavalle 2 (1).png>)
...
<figure><img src="../.gitbook/assets/Luo-käyttäjätili2.png" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Käyttäjäprofiili2.png" alt=""><figcaption><p>Asetukset ja profiilit kohdasta löydät käyttäjäprofiilin asetukset.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Ilmoitukset_muokattu_viiva.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Tiimikanava (2).png" alt=""><figcaption><p>Tiimikanavanäkymä: Keskustelu ja jäsenlistapalkki </p></figcaption></figure>
...
{% content-ref url="../kayttoliittyma/tiimikanavat/" %}
[tiimikanavat](../kayttoliittyma/tiimikanavat/)
{% endcontent-ref %}

{% content-ref url="../kayttoliittyma/tiimikanavat/yksityiskeskustelut.md" %}
[yksityiskeskustelut.md](../kayttoliittyma/tiimikanavat/yksityiskeskustelut.md)
{% endcontent-ref %}

{% content-ref url="../kayttoliittyma/kayttoliittyman-esittely/" %}
...
<figure><img src="../.gitbook/assets/Asiakasjonon tilat_.png" alt=""><figcaption><p>Asiakasjono sivupalkissa: Suljettu (punainen), avattu (vihreä), asiakas jonossa (sininen)</p></figcaption></figure>

<figure><img src="../.gitbook/assets/Nappaa-asiakas-jonosta-01.png" alt=""><figcaption><p>Nappaa asiakas jonossa. Näet jonotusajan ja voit aloittaa asiakaskeskustelun valikosta tai jonon loginäkymästä.</p></figcaption></figure>

### Asiakaskeskustelunäkymä <a href="#asiakaskeskustelunakyma" id="asiakaskeskustelunakyma"></a>

<figure><img src="../.gitbook/assets/Asiakaskeskustelunäkymä_01 (1).png" alt=""><figcaption></figcaption></figure>

<table data-header-hidden><thead><tr><th width="197">1) Sivupalkki</th><th width="212.66666666666666">2) Keskustelunäkymä</th><th>3) Chat-sivupalkki</th></tr></thead><tbody><tr><td><strong>1) Sivupalkki</strong></td><td><strong>2) Keskustelunäkymä</strong></td><td><strong>3) Asiakaskeskustelun tiedot</strong></td></tr><tr><td><ol><li>Organisaatio</li><li>Asiakasjonot</li><li>Tiimi- ja tukikanavat</li><li>Asiakaskeskustelut</li><li>Yksityiskeskustelut</li></ol></td><td><ol><li>Tietoja asiakkaasta</li><li>Keskustelu</li><li>Tekstikenttä, hymiöt, liitetiedostot, videokeskustelu</li><li>Merkinnät</li><li>Tagit </li><li>Valmisvastaukset</li></ol><p></p><p></p></td><td><ol><li>Henkilökohtaiset valmisvastaukset</li></ol><p></p></td></tr></tbody></table>
...
![Moderointityökalut](<../.gitbook/assets/Moderaattorin työkalut ja valinnat.png>)
...
{% content-ref url="../kayttoliittyma/yleisia-vinkkeja/ongelmat-kirjautumisessa.md" %}
[ongelmat-kirjautumisessa.md](../kayttoliittyma/yleisia-vinkkeja/ongelmat-kirjautumisessa.md)
{% endcontent-ref %}

{% content-ref url="../kayttoliittyma/yleisia-vinkkeja/ongelmat-kayttoliittymassa.md" %}
