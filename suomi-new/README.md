...
{% content-ref url="kayttoliittyma/kayttoliittyman-esittely/mita-uutta.md" %}
[mita-uutta.md](kayttoliittyma/kayttoliittyman-esittely/mita-uutta.md)
{% endcontent-ref %}
...
{% content-ref url="kayttoliittyma/organisaatio/organisaation-jasenten-hallinta/uuden-agentin-lisaaminen.md" %}
[uuden-agentin-lisaaminen.md](kayttoliittyma/organisaatio/organisaation-jasenten-hallinta/uuden-agentin-lisaaminen.md)
{% endcontent-ref %}

{% content-ref url="asiakasneuvojat/kayttajatili/kayttajatilin-luonti.md" %}
[kayttajatilin-luonti.md](asiakasneuvojat/kayttajatili/kayttajatilin-luonti.md)
{% endcontent-ref %}
...
{% content-ref url="kayttoliittyma/asiakasjonojen-hallinta/jonon-asetukset.md" %}
[jonon-asetukset.md](kayttoliittyma/asiakasjonojen-hallinta/jonon-asetukset.md)
{% endcontent-ref %}
