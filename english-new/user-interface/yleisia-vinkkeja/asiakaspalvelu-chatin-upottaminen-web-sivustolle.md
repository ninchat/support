---
description: >-
  You can place a customer service chat on a website, mobile site and
  application, blog, or Facebook page.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2uaSodGerm08OIAGW4lA/kayttoliittyma/yleisia-vinkkeja/asiakaspalvelu-chatin-upottaminen-web-sivustolle
---

# Embedding chat on website

### Chat embed code <a href="#chat-embed-code" id="chat-embed-code"></a>
...
#### Place the embed code <a href="#place-the-embed-code" id="place-the-embed-code"></a>

We recommend placing the script tag at the end of the body element of the web page. Exampl
...
#### Add Ninchat to Wordpress <a href="#add-ninchat-to-wordpress" id="add-ninchat-to-wordpress"></a>
...
![Adding Ninchat to Worpress site.](<../../.gitbook/assets/Wordpress Ninchat Ohje.png.jpg>)
