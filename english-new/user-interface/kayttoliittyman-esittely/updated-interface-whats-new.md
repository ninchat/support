...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2uaSodGerm08OIAGW4lA/kayttoliittyma/kayttoliittyman-esittely/updated-interface-whats-new
---
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (115).png" alt=""><figcaption><p>User menu.</p></figcaption></figure></div>
...
<div align="left" data-with-frame="true"><figure><img src="../../.gitbook/assets/image (106).png" alt="" width="267"><figcaption><p>Organization main menu</p></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (107).png" alt="" width="563"><figcaption><p>Notifications in the user menu.</p></figcaption></figure></div>
...
During a chat, you can now use **canned messages** (<img src="../../.gitbook/assets/valmisvastaukse.png" alt="" data-size="line">). You can also enable the traditional list view for your own quick replies from your profile settings under **Shared canned messages**. After enabling this, your quick replies will appear in the right‑hand sidebar, which can be opened using the <img src="../../.gitbook/assets/Slider-menu.png" alt="" data-size="line"> icon. Notes and tag views are opened from the message input fields tab menu.

<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (108).png" alt=""><figcaption><p>The conversation section functionalities.</p></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (112).png" alt=""><figcaption><p>You can find all canned messages from the conversation section, and your personal canned messages separately from the Audience info element.</p></figcaption></figure></div>

{% content-ref url="../organisaatio/organization-canned-messages.md" %}
[organization-canned-messages.md](../organisaatio/organization-canned-messages.md)
{% endcontent-ref %}
