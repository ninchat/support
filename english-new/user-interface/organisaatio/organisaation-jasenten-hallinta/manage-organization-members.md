...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2uaSodGerm08OIAGW4lA/kayttoliittyma/organisaatio/organisaation-jasenten-hallinta
---

# Manage organization members

## Managing agents in organization <a href="#managing-agents-in-organization" id="managing-agents-in-organization"></a>
...
Click the three-dot menu on the right-hand side of the member’s row to open the view for managing functionalities.

* Add or remove the member as an agent in customer service queues.
* Add or remove operator permissions for the member’s organization.
* Remove member from the organization – this action removes the user from the queues, channels and the organization.&#x20;

For more information, see Adding a member as a queue agent.

## Search for organization members <a href="#organisaation-jasenten-haku" id="organisaation-jasenten-haku"></a>
