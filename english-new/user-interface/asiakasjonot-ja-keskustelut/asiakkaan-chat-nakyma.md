...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2uaSodGerm08OIAGW4lA/kayttoliittyma/asiakasjonot-ja-keskustelut/asiakkaan-chat-nakyma
---
...
### Minimized view <a href="#minimized-view" id="minimized-view"></a>
...
### Pop-up window <a href="#pop-up-window" id="pop-up-window"></a>
...
## Pre questionnaire and queueing&#x20;

![](../../.gitbook/assets/embed-queued-questionnaire.png)

### Pre questionnaire <a href="#pre-questionnaire" id="pre-questionnaire"></a>
...
Apart from text messages and pictures, you can chat with the customer via video. In addition to the video camera, you can also share your screen (if allowed in the queue settings). Video and screen sharing do not require any additional software but usually compatible with newer browsers.
