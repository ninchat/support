---
description: An introduction to organization management on Ninchat.
icon: building
metaLinks:
  alternates:
    - https://app.gitbook.com/s/2uaSodGerm08OIAGW4lA/kayttoliittyma/organization
---

# Organization

## General information <a href="#general-info" id="general-info"></a>
...
| <p><strong>Organization owner</strong>  <img src="../../.gitbook/assets/owner-key.png" alt="" data-size="line"> </p><p>(in development)</p> | An organization owner is the agent who created the organization. He/she can add encryption keys to your organization for transmitting encrypted metadata.                                                                                                 |
...
{% content-ref url="organization-member-management/" %}
[Organization member management](organization-member-management/)
{% endcontent-ref %}

{% content-ref url="organization-member-management/add-new-member.md" %}
[add-new-member.md](organization-member-management/add-new-member.md)
{% endcontent-ref %}
