...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2uaSodGerm08OIAGW4lA/asiakasneuvojat/user-account/user-settings
---
...
* [#user-profile](user-settings.md#user-profile "mention")
* [#kirjautumisvalinnat](user-settings.md#kirjautumisvalinnat "mention")
* [#notifications](user-settings.md#notifications "mention")
* [#interface-and-display-options](user-settings.md#interface-and-display-options "mention")
* [#language-and-region](user-settings.md#language-and-region "mention")
* [#canned-messages](user-settings.md#canned-messages "mention")

{% hint style="info" %}
The Ninchat interface is automatically displayed in the language set for your web browser. You can change this in Settings under [#language-and-region](user-settings.md#language-and-region "mention").
{% endhint %}
...
## Account & password <a href="#kirjautumisvalinnat" id="kirjautumisvalinnat"></a>
...
{% content-ref url="delete-account.md" %}
[delete-account.md](delete-account.md)
{% endcontent-ref %}
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Ninchat New client - Forgot password.PNG" alt=""><figcaption><p>Changing your password.</p></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Käyttäjäasetukset_korostukset.png" alt=""><figcaption></figcaption></figure></div>
...
### Always receive notifications <a href="#always-receive-notifications" id="always-receive-notifications"></a>
...
### Desktop notifications <a href="#desktop-notifications" id="desktop-notifications"></a>
...
![Example of a desktop notification (Windows): Customer in queue.](<../../.gitbook/assets/Vierailija jonossa.png>)
...
<figure><img src="../../.gitbook/assets/Valmisvastausten hallinta.png" alt=""><figcaption></figcaption></figure>
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (193).png" alt=""><figcaption><p>Adding a new canned message.</p></figcaption></figure></div>
