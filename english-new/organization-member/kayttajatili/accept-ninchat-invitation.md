...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2uaSodGerm08OIAGW4lA/asiakasneuvojat/kayttajatili/accept-ninchat-invitation
---

# Ninchat invitation

## Accept an invitation <a href="#accept-an-invitation" id="accept-an-invitation"></a>

Get started with an invitation link you receive from your Ninchat organization admin user. After accepting the invitation you can create your Ninchat account.
...
### Signing up without an invitation <a href="#signing-up-without-an-invitation" id="signing-up-without-an-invitation"></a>
...
### Expired invitation <a href="#expired-invitation" id="expired-invitation"></a>
...
{% hint style="info" %}
<mark style="color:$primary;">Use invitation link only once. After accepting invitation and creating your account, you can sign in to Ninchat using this address</mark> [<mark style="color:$primary;">**https://ninchat.com/new**</mark>](https://ninchat.com/new)
{% endhint %}
