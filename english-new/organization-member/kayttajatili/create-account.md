...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2uaSodGerm08OIAGW4lA/asiakasneuvojat/kayttajatili/create-account
---
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (180).png" alt="" width="181"><figcaption></figcaption></figure></div>

## Verify your account <a href="#verify-your-account" id="verify-your-account"></a>
...
{% hint style="info" %}
**The verification link is for one-time use** - you need to click it only once. After that, you can sign in at [**https://ninchat.com/new**](https://ninchat.com/new)**.**
{% endhint %}

<figure><img src="../../.gitbook/assets/Please verify your email (1).png" alt=""><figcaption><p> Click to verify.</p></figcaption></figure>
...
Sometimes it can take a moment for the verification mail to arrive. Wait a minute and try to refresh your mail inbox view. If you can't find the verification mail in your inbox, check your spam folder. If it's not there either, you can order a new verification link mail from your Ninchat user settings.

{% content-ref url="user-settings.md" %}
[user-settings.md](user-settings.md)
{% endcontent-ref %}

### Outdated verification link <a href="#outdated-verification-link" id="outdated-verification-link"></a>
...
#### Sign in with your email address and password at: [https://ninchat.com/new](https://ninchat.com/new)​

(Use the verification link only once.)

<figure><img src="../../.gitbook/assets/Kirjaudu.png" alt="" width="188"><figcaption></figcaption></figure>
