...
![](../.gitbook/assets/invite-accept%20%281%29.png)
...
![](../.gitbook/assets/invite-accept-signup%20%282%29.png)
...
![Allowing notifications in different web browsers](../.gitbook/assets/new-user-notification-permit%20%281%29.png)
...
## User settings <a id="kayttajaasetukset"></a>

### 1. User profile <a id="1-kayttajaprofiili"></a>
...
![](../.gitbook/assets/user_settings_notifications%20%282%29.png)
...
![Pick the customer from queue. You can see the queue time and you can pick the customer from the menu. ](../.gitbook/assets/sidebar-queue-bar-customer-fi%20%281%29.png)

### Customer chat view <a id="asiakaskeskustelunakyma"></a>
...
<table>
  <thead>
    <tr>
      ...
      <th style="text-align:left">2) Chat view</th>
      <th style="text-align:left">3) Chat-sidebar</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="text-align:left">
        <ol>
          <li>Organization</li>
          <li>Customer queues</li>
          <li>Team and support channels</li>
          <li>Customer chat</li>
          <li>Private conversations with team mates</li>
        </ol>
      </td>
      <td style="text-align:left">
        <ol>
          ...
          <li>Conversation</li>
          <li>Text area, emojis, attachments, video chat, showing/hiding the sidebar</li>
        </ol>
        <p></p>
        <p></p>
      </td>
      <td style="text-align:left">
        <ol>
          <li>Memos</li>
          <li>Ready answers</li>
          <li>Tags (merkit) to categorize chats</li>
        </ol>
        <p></p>
      </td>
    </tr>
...
{% page-ref page="../customer-service-queues-and-conversations/picking-customer-from-queue.md" %}

{% page-ref page="../customer-service-queues-and-conversations/having-a-customer-audience.md" %}

{% page-ref page="../customer-service-queues-and-conversations/opening-and-closing-queue.md" %}

{% page-ref page="../customer-service-queues-and-conversations/ending-audience.md" %}
...
![Moderator tools](../.gitbook/assets/channel-embed-moderation%20%281%29.png)
