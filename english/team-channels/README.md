...
| <img src="../.gitbook/assets/online.png" alt="" data-size="line"> Green circle      | User is logged in and active.                                                                                               |
| <img src="../.gitbook/assets/idle.png" alt="" data-size="line"> Orange circle       | User is logged in but not active.                                                                                           |
| <img src="../.gitbook/assets/offline-avatar.png" alt="" data-size="line"> No circle | User is offline. The user will see messages addressed to him/her later.                                                     |
...
Write your messages in the text field (where it is written "Enter your message"), at the bottom of the conversation section. The text field grows bigger when you write longer. Click the<img src="../.gitbook/assets/textarea-5.png" alt="" data-size="line">-send button or use the \[Enter] key on your keyboard to send a message. If you want to make a line break in your messages, use the \[Shift] + \[Enter] keys on the keyboard.

You can add emojis to your messages by clicking the smiley face icon and choose from the list.

#### Files

If files are allowed, you can click the<img src="../.gitbook/assets/textarea-2.png" alt="" data-size="line">-paperclip icon to upload a picture or file from your desktop/device to the channel conversation. Image files are displayed as thumbnails where you can click to open them. Other types of files are displayed as a link that users can click to download.
...
{% content-ref url="/broken/pages/-LNjmzsPemtK140f2LXA" %}
[Broken link](/broken/pages/-LNjmzsPemtK140f2LXA)
{% endcontent-ref %}
