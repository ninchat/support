...
| Symbol                                                                             | Meaning                                                                                                                           |
| ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| <img src="../.gitbook/assets/operator.png" alt="" data-size="line"> Star, filled   | Channel operator user - can manage channel settings and invite new members to the channel (different from organization operator). |
| <img src="../.gitbook/assets/moderator.png" alt="" data-size="line"> Star, outline | Channel moderator user - can moderate posts and delete channel members.                                                           |
