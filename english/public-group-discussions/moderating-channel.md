...
Moderation tools appear when the agent has been granted moderator rights<img src="../.gitbook/assets/moderator.png" alt="" data-size="line">of that channel. Channel operators can give moderator rights to other agents.
...
| Tool                                                                                                        | Function                                                                                                                      |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| <img src="../.gitbook/assets/mod1.png" alt="" data-size="line"> **Hide message**                            | Hide this message from other users.                                                                                           |
| <img src="../.gitbook/assets/unhide-message.png" alt="" data-size="line"> **Show message**                  | Show the hidden message.                                                                                                      |
| <img src="../.gitbook/assets/mod2.png" alt="" data-size="line"> **Silence user**                            | This user is muted for now.                                                                                                   |
| <img src="../.gitbook/assets/mod3.png" alt="" data-size="line"> **Silence this user for time being**        | This user is muted for the selected period of time (after that he/she can write again).                                       |
| <img src="../.gitbook/assets/mod4.png" alt="" data-size="line"> **Hide all messages from this user**        | All messages from this user will be hidden from other users.                                                                  |
| <img src="../.gitbook/assets/mod5.png" alt="" data-size="line"> **Toggle hide new messages from this user** | New messages from this user will be hidden/ shown as standard (moderators can manually hide/ show each message individually). |
