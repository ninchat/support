...
Type your message in the command line ("Enter your message"). Send it by clicking \[ENTER] key or the  <img src="../.gitbook/assets/icon-submit.PNG" alt="" data-size="line">Send-icon.
