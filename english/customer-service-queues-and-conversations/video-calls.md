...
| Symbol                                                                        | Function                                                                              |
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| <img src="../.gitbook/assets/video-toggle.png" alt="" data-size="line">       | <p>Expand video call to full screen/</p><p>Minimize video call to normal window.</p>  |
| <img src="../.gitbook/assets/video-soundonoff.png" alt="" data-size="line">   | Audio on/off - Mute the sound from the other side of the conversation.                |
| <img src="../.gitbook/assets/video-miconoff.png" alt="" data-size="line">     | Microphone on/off - Disable your microphone so that the other person cannot hear you. |
| <img src="../.gitbook/assets/video-cameraonoff.png" alt="" data-size="line">  | Video on/off - Disable your camera so that the other person cannot see you.           |
| <img src="../.gitbook/assets/video-screenshare.png" alt="" data-size="line">  | Screen sharing on/off - Instead of camera, share your screen, program window or tab.  |
| <img src="../.gitbook/assets/video-settings.png" alt="" data-size="line">     | Open video settings                                                                   |
| <img src="../.gitbook/assets/video-hangup.png" alt="" data-size="line">       | End the video call. (This does not end the chat.)                                     |
...
1. Click screen sharing icon<img src="../.gitbook/assets/video-screenshare.png" alt="" data-size="line">&#x20;
...
| ------------------------------------ | --------------------------------------------------------------------------------------- |
| Windows                              | <p>Google Chrome<br>Mozilla Firefox<br>Microsoft Edge (2020 Chromium-based version)</p> |
| <p>Mac OS</p><p>(Apple desktops)</p> | <p>Google Chrome<br>Mozilla Firefox<br>Apple Safari</p>                                 |
| Android                              | <p>Google Chrome<br>Mozilla Firefox</p>                                                 |
...
>
> Open video settings during a video call clicking <img src="../.gitbook/assets/video-settings.png" alt="" data-size="line">icon and check which camera and microphone device is used.
