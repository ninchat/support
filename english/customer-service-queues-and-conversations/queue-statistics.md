...
{% hint style="info" %}
<img src="../.gitbook/assets/rating--1.png" alt="" data-size="line">A negative feedback can make you feel uncomfortable, however, it is often valuable. By reading the discussion that caused the negative feedback, you can easily track down the problem.
{% endhint %}
