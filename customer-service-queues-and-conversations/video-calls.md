...
| Symbol                                         | Function                                                                              |
| ---------------------------------------------- | ------------------------------------------------------------------------------------- |
| ![](../.gitbook/assets/video-toggle.png)       | <p>Expand video call to full screen/</p><p>Minimize video call to normal window.</p>  |
| ![](../.gitbook/assets/video-soundonoff.png)   | Audio on/off - Mute the sound from the other side of the conversation.                |
| ![](../.gitbook/assets/video-miconoff.png)     | Microphone on/off - Disable your microphone so that the other person cannot hear you. |
| ![](../.gitbook/assets/video-cameraonoff.png)  | Video on/off - Disable your camera so that the other person cannot see you.           |
| ![](../.gitbook/assets/video-screenshare.png)  | Screen sharing on/off - Instead of camera, share your screen, program window or tab.  |
| ![](../.gitbook/assets/video-settings.png)     | Open video settings                                                                   |
| ![](../.gitbook/assets/video-hangup.png)       | End the video call. (This does not end the chat.)                                     |
